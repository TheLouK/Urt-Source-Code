...
//	Swap_Init ();
	...
	// We need to set the default for com_standalone to 1 before we call FS_InitFilesystem().
	// If we don't set it here, it will default to 0 (if not specified on command-line)
	// and the FS_CheckPak0() will be made.
